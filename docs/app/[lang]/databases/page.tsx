    ...
    <main className="min-h-screen bg-[#08080a] text-landing-ink">
      ...
      <RevealSection className="max-w-[1180px] mx-auto px-7 pb-16 max-[760px]:px-[18px]">
        <div className="landing-glass-card rounded-[10px] p-8 text-center max-w-[640px] mx-auto">
          ...
          <Link href="https://github.com/ActiveInAI/Arch-GPT DB/discussions" target="_blank" className="landing-final-link inline-flex items-center justify-center min-h-[42px] rounded-[7px] px-5 mt-5 text-sm font-[650]">
            {t.ctaLink}
          </Link>
        </div>
      </RevealSection>
