...
<Tabs groupId="platform" items={['macOS', 'Windows', 'Linux', 'Docker']}>
  <Tab value="macOS">
    ...
    You can also download a `.dmg` installer from [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases).
  ...
  <Tab value="Windows">
    ...
    You can also download a `.msi` installer from [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases).
  ...
  <Tab value="Linux">
    ...
    You can also download a package from [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases):
...
```bash
git clone https://github.com/ActiveInAI/Arch-GPT DB.git
cd dbx
make
```
