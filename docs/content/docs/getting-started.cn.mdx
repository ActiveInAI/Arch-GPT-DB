...
<Tabs groupId="platform" items={['macOS', 'Windows', 'Linux', 'Docker']}>
  <Tab value="macOS">
    ...
    也可以从 [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases) 下载 `.dmg` 安装包。
  ...
  <Tab value="Windows">
    ...
    也可以从 [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases) 下载 `.msi` 安装包。
  ...
  <Tab value="Linux">
    ...
    也可以从 [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT DB/releases) 下载对应安装包：
