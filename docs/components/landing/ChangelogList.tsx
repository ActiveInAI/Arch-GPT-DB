    ...
    <details className="changelog-release border-t border-[rgba(155,176,205,0.18)]" open={featured || undefined}>
      ...
      <div className="changelog-release-body py-12 max-[760px]:py-8">
        <div className="flex items-center justify-between gap-4 mb-8 max-[760px]:items-start max-[760px]:flex-wrap max-[760px]:mb-6">
          ...
          <a href={`https://github.com/ActiveInAI/PanDB/releases/tag/${release.tag}`} target="_blank" rel="noopener noreferrer" className="flex min-h-11 items-center gap-1.5 px-4 rounded-full border border-[rgba(155,176,205,0.25)] text-sm text-[#e2e8f0] hover:border-[rgba(155,176,205,0.4)] transition-colors">
            {t.download}
            <ChevronDown size={14} />
          </a>
        </div>
