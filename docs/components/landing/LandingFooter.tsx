      ...
      <div className="max-w-[1180px] mx-auto px-7 py-7 max-[760px]:px-[18px]">
        <div className="flex items-center justify-between gap-4 max-[760px]:flex-col max-[760px]:gap-3 max-[760px]:text-center">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a href="https://github.com/ActiveInAI/Arch-GPT DB" target="_blank" rel="noopener noreferrer" className="inline-flex size-11 items-center justify-center text-[var(--color-landing-muted)] hover:text-[var(--color-landing-ink)] transition-colors" aria-label="GitHub">
              <GithubIcon />
            </a>
