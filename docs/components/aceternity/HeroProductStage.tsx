...
const productSlides = [
  {
    ...
    alt: "PanDB main window light theme",
    label: "Light",
  },
  {
    src: "/screenshot-dark.png",
    alt: "PanDB main window dark theme",
    label: "Dark",
  },
  {
    src: "/screenshot-er.png",
    alt: "PanDB ER diagram",
    label: "ER Diagram",
  },
  {
...
export function HeroProductStage() {
  ...
  return (
    ...
    >
      ...
      <div className="landing-product-dots absolute right-[18px] bottom-4 z-[5] flex items-center rounded-full p-1 max-[760px]:right-2 max-[760px]:bottom-2" aria-label="PanDB product screenshots">
        {productSlides.map((slide, index) => (
