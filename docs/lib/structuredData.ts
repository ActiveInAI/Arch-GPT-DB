...
export function buildSiteStructuredData() {
  return [
    ...
    },
    {
      ...
      sameAs: [
        "https://github.com/ActiveInAI/Arch-GPT DB",
...
export function buildSoftwareApplicationStructuredData(lang: "en" | "cn", version: string) {
  ...
  return {
    ...
    inLanguage: language,
    codeRepository: "https://github.com/ActiveInAI/Arch-GPT DB",
    downloadUrl: "https://github.com/ActiveInAI/Arch-GPT DB/releases/latest",
    releaseNotes: `${SITE_URL}/${lang}/changelog`,
    license: "https://github.com/ActiveInAI/Arch-GPT DB/blob/main/LICENSE",
    screenshot: [
