...
export function buildSiteStructuredData() {
  return [
    ...
    },
    {
      ...
      sameAs: [
        "https://github.com/ActiveInAI/PanDB",
...
export function buildSoftwareApplicationStructuredData(lang: "en" | "cn", version: string) {
  ...
  return {
    ...
    inLanguage: language,
    codeRepository: "https://github.com/ActiveInAI/PanDB",
    downloadUrl: "https://github.com/ActiveInAI/PanDB/releases/latest",
    releaseNotes: `${SITE_URL}/${lang}/changelog`,
    license: "https://github.com/ActiveInAI/PanDB/blob/main/LICENSE",
    screenshot: [
