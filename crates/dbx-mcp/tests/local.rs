...
async fn local_backend_picks_up_connections_added_after_startup_without_reload() {
    // Regression for issue #5428: after an agent connects to MCP, a connection created in the Arch-GPT DB
    ...
    // Simulate a connection created in the Arch-GPT DB desktop UI: write directly to the shared storage,
