...
const AGENT_JAVA_TOO_OLD_MESSAGE: &str =
    "Agent requires Java 21, but Arch-GPT DB started it with an older Java runtime. Use Arch-GPT DB managed JRE 21 or select a Java 21 executable in Driver Manager.";
...
impl AgentDriverClient {
    ...
    /// they speak the Arch-GPT DB stdin/stdout JSON-RPC protocol.
...
mod tests {
    ...
    fn contract_violation_keeps_identity_when_legacy_api_adds_session_id() {
        ...
        assert_eq!(crate::backend_error::BackendError::from_legacy_string(&legacy).code(), "Arch-GPT DB-JDBC-5002");
    }
    ...
    fn legacy_adapter_preserves_strict_identity_when_old_callers_append_context() {
        ...
        assert_eq!(crate::backend_error::BackendError::from_legacy_string(&suffixed).code(), "Arch-GPT DB-JDBC-5002");
    }
