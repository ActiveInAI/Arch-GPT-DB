...
const REGISTRY_PATH: &str = "https://github.com/ActiveInAI/Arch-GPT-DB/releases/download/agents-latest/agent-registry.json";
...
pub fn ensure_driver_app_version(
    ...
    Err(format!(
        "{db_type} driver {} requires Arch-GPT DB {} or newer. Current Arch-GPT DB version is {}.",
