 ...
 * Parse a SELECT statement to determine whether PanDB can bind result columns to
 * base-table columns. DBeaver uses result metadata for the same idea; PanDB has to
