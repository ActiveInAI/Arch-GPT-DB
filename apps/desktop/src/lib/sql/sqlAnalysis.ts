 ...
 * Parse a SELECT statement to determine whether Arch-GPT DB can bind result columns to
 * base-table columns. DBeaver uses result metadata for the same idea; Arch-GPT DB has to
