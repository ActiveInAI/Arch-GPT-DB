...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Arch-GPT DB 將下載已簽署的可攜版 ZIP，結束後僅替換 Arch-GPT DB.exe 並自動重新啟動。portable.pandb 和 data 會保留。",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "設定覆寫了由 Arch-GPT DB 管理的 MCP 環境變數。請從供應商設定中移除 DBX_MCP_* 變數。",
      ...
      piAgentEnvReserved: "設定覆寫了由 Arch-GPT DB 管理的 Pi 或 MCP 環境變數。請移除 DBX_PI_* 與 DBX_MCP_* 變數。",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "此密碼只用於加密和還原敏感資料。Arch-GPT DB 不會儲存；每台裝置都需要再次輸入。",
    syncTest: "測試",
    syncUpload: "上傳",
    syncDownload: "下載",
