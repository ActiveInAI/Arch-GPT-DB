...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "O Arch-GPT DB baixará o ZIP portátil assinado, substituirá apenas o Arch-GPT DB.exe após sair e reiniciará automaticamente. O portable.pandb e os dados serão mantidos.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova as variáveis DBX_MCP_* da configuração do provedor.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova DBX_PI_* e DBX_MCP_* da configuração.",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. O Arch-GPT DB não a salva; digite-a novamente em cada dispositivo.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
