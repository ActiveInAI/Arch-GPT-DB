...
export default withEnglishFallback({
  ...
  externalSqlFile: {
    modifiedTitle: "Arquivo alterado fora do Arch-GPT DB",
    ...
    deletedDescription: "{path} foi excluído ou movido fora do Arch-GPT DB. O conteúdo do editor continua disponível.",
  ...
  updates: {
    ...
    availableMessage: "Arch-GPT DB {latest} está disponível. Você está usando {current}.",
    upToDate: "O Arch-GPT DB está atualizado ({version}).",
    ...
    activeTasksBlockUpdate: "Há {count} tarefa(s) em execução. Aguarde a conclusão antes de atualizar o Arch-GPT DB.",
    portableAutomaticUpdate: "O Arch-GPT DB baixará o ZIP portátil assinado, substituirá apenas o Arch-GPT DB.exe após sair e reiniciará automaticamente. O portable.dbx e os dados serão mantidos.",
  ...
  sidebar: {
    ...
    importDbx: "Importar Configuração Arch-GPT DB",
  ...
  sqlLibrary: {
    ...
    storageHelp: "O conteúdo da Biblioteca SQL é salvo nos dados do aplicativo Arch-GPT DB, não como arquivos .sql independentes no disco.\nPara usá-lo no sistema de arquivos, exporte a Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, mas o Arch-GPT DB não conseguiu lembrar a senha: {message}",
    ...
    oracleTnsPathHint: "O caminho é lido pelo backend do Arch-GPT DB/Oracle Agent. No desktop é local; no Web e Docker pertence ao servidor.",
    ...
    gaussdbConnectionModeNativeHint: "Usa o protocolo compatível com PostgreSQL integrado ao Arch-GPT DB para os modos A/PG/Oracle do GaussDB.",
    ...
    agentJavaTooOld: "Este driver requer Java 21. Use o JRE 21 gerenciado pelo Arch-GPT DB ou selecione um executável Java 21 no Gerenciador de Drivers.",
    ...
    jdbcPluginHint: "Instale primeiro o plugin JDBC do Arch-GPT DB e depois importe o JAR do driver JDBC do fornecedor do banco de dados.",
    ...
    kafkaKerberosKeytabPlaceholder: "Caminho na máquina do Arch-GPT DB Agent, por exemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, caminho na máquina do Arch-GPT DB Agent, por exemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Os caminhos do keytab e do krb5.conf são lidos pelo Arch-GPT DB Agent e devem existir na máquina onde o Arch-GPT DB Agent é executado; os arquivos não são enviados do navegador atual.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} abas SQL que você está fechando têm alterações não salvas. O Arch-GPT DB está mostrando "{title}" no momento. Salvar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tem alterações SQL não salvas que serão perdidas se você sair do Arch-GPT DB. Salvar antes de sair?',
    unsavedChangesAppCloseMultipleMessage: '{count} abas SQL têm alterações não salvas. O Arch-GPT DB está mostrando "{title}" no momento. Serão perdidas se você sair do Arch-GPT DB. Salvar antes de sair?',
  ...
  tabs: {
    ...
    externalFileMissing: "Excluído ou movido fora do Arch-GPT DB",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "Esta operação atualiza imediatamente todas as linhas correspondentes no momento da execução, incluindo linhas não carregadas. O Arch-GPT DB não pode gerar uma reversão confiável.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "O Arch-GPT DB não conseguiu identificar exatamente uma tabela de destino segura para gravar este resultado.",
      ...
      "metadata-unavailable": "O Arch-GPT DB não conseguiu carregar os metadados da tabela, portanto a edição do resultado está desabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "A importação criptografada não está disponível neste contexto do navegador. Use HTTPS, localhost ou Arch-GPT DB Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Arch-GPT DB MCP Server obrigatório",
    codexMcpRequiredDescription: "O Codex CLI usa o Arch-GPT DB MCP Server para acessar o schema do banco e as ferramentas de consulta. Instale-o antes de usar o Codex no assistente de AI.",
    ...
    codexCliEnvReservedName: "{name} é gerenciada pelo Arch-GPT DB para o MCP Server e não pode ser definida aqui.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova as variáveis Arch-GPT DB_MCP_* da configuração do provedor.",
      ...
      claudeCodeMcpConfigInvalid: "O Claude Code não conseguiu ler ou analisar a configuração MCP do Arch-GPT DB. Verifique a versão e o caminho do executável do Claude Code CLI.",
      dbxMcpMissing: "Uma instalação compatível do Arch-GPT DB MCP Server não foi encontrada. Verifique Configurações > MCP e reinstale ou atualize.",
      claudeCodeMcpStartupFailed: "O Claude Code carregou a configuração MCP, mas não conseguiu iniciar o Arch-GPT DB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      claudeCodeCommandLineTooLong: "O Windows rejeitou o comando do Claude Code porque era muito longo. Atualize o Arch-GPT DB e tente novamente com o arquivo MCP gerado.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova Arch-GPT DB_PI_* e Arch-GPT DB_MCP_* da configuração.",
      ...
      piAgentMcpStartupFailed: "O Pi não conseguiu iniciar a ponte MCP do Arch-GPT DB. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      openCodeEnvReserved: "Uma variável gerenciada pelo OpenCode ou Arch-GPT DB foi sobrescrita. Remova as variáveis de controle OPENCODE e Arch-GPT DB_MCP_* da configuração.",
      ...
      openCodeMcpStartupFailed: "O OpenCode não conseguiu iniciar o servidor Arch-GPT DB MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      cursorEnvReserved: "Uma variável gerenciada pelo Cursor ou Arch-GPT DB foi sobrescrita. Remova CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e Arch-GPT DB_MCP_* da configuração.",
      cursorNotAuthenticated: "O Cursor CLI não está autenticado. Execute `agent login` no terminal e tente novamente.",
      cursorMcpStartupFailed: "O Cursor não conseguiu iniciar o servidor Arch-GPT DB MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      grokCliEnvReserved: "Uma variável MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova as variáveis Arch-GPT DB_MCP_* da configuração do provedor.",
      grokCliNotAuthenticated: "Grok CLI não está autenticado. Execute `grok login` em um terminal e tente novamente.",
      grokCliMcpStartupFailed: "O Grok carregou a configuração MCP, mas não conseguiu iniciar o Arch-GPT DB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      grokCliCommandLineTooLong: "O Windows rejeitou o comando do Grok CLI porque era muito longo. Atualize o Arch-GPT DB e tente novamente com o arquivo de prompt gerado.",
      ...
      codeBuddyEnvReserved: "Uma variável MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova as variáveis Arch-GPT DB_MCP_* da configuração do provedor.",
      ...
      codeBuddyMcpConfigInvalid: "O CodeBuddy Code não conseguiu ler a configuração temporária do Arch-GPT DB MCP. Verifique os detalhes abaixo.",
      codeBuddyMcpStartupFailed: "O CodeBuddy Code carregou a configuração MCP, mas não conseguiu iniciar o Arch-GPT DB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      qoderEnvReserved: "Uma variável de ambiente MCP gerenciada pelo Arch-GPT DB foi sobrescrita. Remova as variáveis Arch-GPT DB_MCP_* da configuração do provedor.",
      ...
      qoderMcpConfigInvalid: "O Qoder CLI não conseguiu ler a configuração MCP temporária do Arch-GPT DB. Verifique a versão do Qoder CLI e os detalhes abaixo.",
      qoderMcpStartupFailed: "O Qoder CLI carregou a configuração MCP, mas não conseguiu iniciar o Arch-GPT DB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
    ...
    closeWithRunsDescription: "Sair do Arch-GPT DB interromperá {count} tarefa(s) de AI em execução ou na fila. Você também pode fechar esta caixa de diálogo e deixá-las terminar.",
    ...
    productionWriteBlocked: "A IA não pode executar alterações de dados ou esquema em um banco de dados de produção. Revise este SQL e execute-o manualmente no Arch-GPT DB.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT está marcado, o Arch-GPT DB omite esse argumento para que o banco de dados use o padrão do procedimento.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "O estado do cluster continua disponível. O Arch-GPT DB solicita /metrics diretamente ao endpoint etcd atual; confirme se a URL resultante pode ser acessada pelo aplicativo Arch-GPT DB.",
  ...
  sqlParameters: {
    ...
    description: "Preencha valores para marcadores de template SQL. O Arch-GPT DB substitui antes de executar o SQL.",
    name: "Parâmetro",
    syntax: "Sintaxe",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Padrão do Arch-GPT DB",
    ...
    iconThemeDefaultDescription: "Usar o ícone colorido do app Arch-GPT DB.",
    iconThemeBlack: "Preto",
    iconThemeBlackDescription: "Use o logo preto da Arch-GPT DB no app.",
    ...
    showTrayIconDescription: "Quando desativado, nenhum ícone é exibido, mas fechar a janela ainda oculta o Arch-GPT DB em segundo plano como antes.",
    quitOnClose: "Sair ao fechar a janela",
    quitOnCloseDescription: "Quando ativado, o botão de fechar encerra o Arch-GPT DB completamente em vez de minimizar para a bandeja.",
    ...
    closeActionQuit: "Sair do Arch-GPT DB",
    closeActionMinimize: "Minimizar para a bandeja",
    updateNotificationsEnabled: "Ativar lembretes de atualização",
    updateNotificationsEnabledDescription: "Quando desativado, o Arch-GPT DB não verificará automaticamente atualizações do app ou dos drivers nem mostrará indicadores. Verificações manuais continuam disponíveis.",
    ...
    duckDbWorkerProcessIsolationDescription: "Executa consultas DuckDB em um processo worker separado. Se uma consulta longa não responder ao cancelamento, o Arch-GPT DB pode encerrar o processo worker para liberar o bloqueio do arquivo de banco de dados.",
    duckDbWorkerMaxProcesses: "Máximo de workers simultâneos do DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita quantos processos worker do DuckDB o Arch-GPT DB pode executar ao mesmo tempo. Intervalo: 1-16. Padrão: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicie o Arch-GPT DB para que esta alteração entre em vigor.",
    restartDbx: "Reiniciar Arch-GPT DB",
    restartDbxFailed: "Falha ao reiniciar o Arch-GPT DB: {error}",
    ...
    openTabsRestoreModeDescription: "Escolha como o Arch-GPT DB restaura as abas que estavam abertas na última vez.",
    ...
    syncWebDavDescription: "Envie ou restaure um snapshot do Arch-GPT DB, incluindo a biblioteca SQL salva, a partir de um serviço de armazenamento compatível com WebDAV.",
    syncWebDavWebDescription: "No modo Web, o servidor Arch-GPT DB acessa o WebDAV sem as restrições de CORS do navegador. As senhas salvas permanecem na instância Arch-GPT DB atual.",
    ...
    syncRememberWebDavPasswordDescription: "A senha é criptografada e armazenada apenas na instância Arch-GPT DB atual. Ela não é sincronizada para o WebDAV e não substitui a senha de sincronização.",
    syncRemotePath: "Caminho remoto do snapshot",
    syncRemotePathDescription: "O Arch-GPT DB criará as pastas pai ausentes ao enviar.",
    syncSecretNotice: "Por padrão, o Arch-GPT DB sincroniza apenas detalhes de conexão e configurações. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais.",
    syncSecrets: "Sincronizar segredos criptografados",
    syncSecretsDescription: "Quando ativado, o Arch-GPT DB criptografa senhas de banco de dados, senhas SSH e chaves de API de IA antes de enviá-las para o WebDAV.",
    syncSecretsPassphrase: "Senha de sincronização",
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. Ela é criptografada na instância Arch-GPT DB atual; digite-a novamente em outras instâncias.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    syncAutoUploadDescription: "Executa enquanto o Arch-GPT DB está aberto. Downloads ainda exigem confirmação manual para evitar substituir SQL salvos localmente.",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do Arch-GPT DB? Os metadados locais e os SQL salvos serão substituídos.",
    apply: "Aplicar",
    ...
    appCloseUnsavedTabsModeDescription: "Escolha o que acontece ao sair do Arch-GPT DB com abas SQL contendo edições não salvas.",
    appCloseUnsavedTabsModePrompt: "Perguntar se deseja salvar",
    appCloseUnsavedTabsModeKeepDrafts: "Sair e manter rascunhos",
    appCloseUnsavedTabsModeHint: 'Os rascunhos são mantidos como abas não salvas e restaurados na próxima vez que você iniciar o Arch-GPT DB. Requer que "Restaurar abas ao iniciar" não esteja definido como "Não manter abas".',
    appCloseDraftPersistFailed: "O Arch-GPT DB não conseguiu salvar os rascunhos das abas abertas, então a saída foi cancelada. Verifique o espaço em disco e as permissões dos arquivos e tente novamente. Detalhes: {message}",
    ...
    sqlVariableSyntaxDescription: "Escolha quais sintaxes de variáveis e espaços reservados o Arch-GPT DB substitui antes de executar SQL, por tipo de banco de dados. Todas ativadas por padrão.",
    ...
    jdbcPlugin: "Plugin JDBC do Arch-GPT DB",
    ...
    mcpDescription: "Verifique a instalação e a versão do Servidor MCP do Arch-GPT DB usado pelo Claude Code, Cursor e outros agentes.",
    ...
    mcpConfigOptionsHint:
      "O Arch-GPT DB controla centralmente o acesso às conexões e as permissões de execução para todos os clientes MCP. A configuração gerada contém apenas os parâmetros de execução necessários para iniciar o servidor MCP e conectá-lo a esta instância do Arch-GPT DB, sem variáveis de permissão ou escopo de conexão.",
    mcpScopeConnection: "Conexões permitidas para MCP",
    mcpScopeConnectionDescription: "O Arch-GPT DB expõe ao MCP apenas as conexões selecionadas. As alterações se aplicam a todos os clientes MCP.",
    ...
    mcpExecutionModeDescription: "Escolha o nível de permissão que o Arch-GPT DB aplica a todos os clientes MCP. As configurações de leitura e gravação do cliente não podem alterar este nível.",
    ...
    mcpExecutionModeReadOnlyDescription: "Permite apenas solicitações classificadas pelo Arch-GPT DB como leitura; bloqueia gravações reconhecidas e alterações de conexão. As permissões da conta do banco continuam sendo o limite de segurança final.",
    ...
    mcpCapabilityDescription: "Estas são operações representativas; solicitações que o Arch-GPT DB não consegue classificar com segurança exigem acesso completo.",
    ...
    mcpDetectionTiming: "O Arch-GPT DB verifica automaticamente quando esta página é aberta; use Verificar novamente para atualizar.",
    mcpNpmBoundary: "O Arch-GPT DB apenas verifica e explica o status do MCP; a instalação e as atualizações ainda são feitas pelo npm.",
    ...
    supportInfoAppVersion: "Versão do Arch-GPT DB",
    ...
    syncSnippetMigrateLegacyConfirm: "O Arch-GPT DB criará primeiro uma substituição criptografada e depois excluirá permanentemente o snippet legado em texto simples {id}. Esta ação não pode ser desfeita. Continuar?",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Selecione os drivers Agent gerenciados pelo Arch-GPT DB que serão incluídos. O pacote é compatível apenas com a plataforma atual.",
    ...
    offlineExportNoDrivers: "Nenhum driver Agent gerenciado pelo Arch-GPT DB elegível está instalado.",
    ...
    offlineExportSecurityHint: "Somente artefatos gerenciados pelo Arch-GPT DB e as JRE necessárias são incluídos. Caminhos locais, configurações e drivers externos são excluídos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "O artefato não está registrado como uma instalação gerenciada pelo Arch-GPT DB.",
    ...
    offlineExportUnavailable_missingManagedJre: "A JRE gerenciada pelo Arch-GPT DB necessária não está instalada.",
    offlineExportUnavailable_invalidManagedJre: "A JRE gerenciada pelo Arch-GPT DB necessária é inválida ou insegura.",
    refresh: "Atualizar",
    javaRuntime: "Runtime do Java",
    javaRuntimeManaged: "JRE gerenciada pelo Arch-GPT DB",
    ...
    localInstallHint: "Para ambientes sem acesso à internet: em outro computador com internet, baixe o dbx-jdbc-plugin-*.zip oficial na página de Releases do Arch-GPT DB no GitHub, transfira-o para esta máquina e selecione-o — nenhum acesso à rede é necessário aqui.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Deixe vazio para o Arch-GPT DB gerar um UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "O Arch-GPT DB verifica a leitura de configurações e serviços antes de oferecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexao usa a API Console do Nacos 3 (normalmente a porta 8080). Informe um nome ou ID de namespace; o Arch-GPT DB converte o nome no ID real quando consegue ler o diretorio.",
    ...
    persistentInstanceHint: "O Arch-GPT DB não registra instâncias efêmeras porque não consegue manter seus heartbeats.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "O Arch-GPT DB executará backups agendados quando estiver aberto, inclusive quando minimizado na bandeja.",
