...
export default withEnglishFallback({
  ...
  externalSqlFile: {
    modifiedTitle: "El archivo cambió fuera de PanDB",
    ...
    deletedDescription: "{path} fue eliminado o movido fuera de PanDB. El contenido del editor sigue disponible.",
  ...
  updates: {
    ...
    availableMessage: "PanDB {latest} está disponible. Estás usando la versión {current}.",
    upToDate: "PanDB está actualizado ({version}).",
    ...
    activeTasksBlockUpdate: "Hay {count} tarea(s) en ejecución. Espera a que terminen antes de actualizar PanDB.",
    portableAutomaticUpdate: "PanDB descargará el ZIP portable firmado, reemplazará solo PanDB.exe después de salir y se reiniciará automáticamente. portable.pandb y data se conservarán.",
  ...
  sidebar: {
    ...
    importDbx: "Importar configuración PanDB",
  ...
  connection: {
    ...
    oracleTnsPathHint: "La ruta la lee el backend de PanDB/Oracle Agent. En escritorio es local; en Web y Docker pertenece al servidor.",
    ...
    gaussdbConnectionModeNativeHint: "Usa el protocolo compatible con PostgreSQL integrado en PanDB para los modos A/PG/Oracle de GaussDB.",
    ...
    agentJavaTooOld: "Este controlador requiere Java 21. Use el JRE 21 administrado por PanDB o seleccione un ejecutable Java 21 en el Administrador de controladores.",
    ...
    jdbcPluginHint: "Instala primero el plugin JDBC de PanDB y luego importa el JAR del driver JDBC del proveedor.",
    ...
    kafkaKerberosKeytabPlaceholder: "Ruta en la máquina donde se ejecuta PanDB Agent, por ejemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, ruta en la máquina donde se ejecuta PanDB Agent, por ejemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Las rutas de keytab y krb5.conf son leídas por PanDB Agent y deben existir en la máquina donde se ejecuta PanDB Agent; no se subirán archivos desde el navegador actual.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} pestañas SQL que vas a cerrar tienen cambios sin guardar. PanDB muestra actualmente "{title}". ¿Guardar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tiene cambios SQL sin guardar que se perderán si sales de PanDB. ¿Guardar antes de salir?',
    unsavedChangesAppCloseMultipleMessage: '{count} pestañas SQL tienen cambios sin guardar. PanDB muestra actualmente "{title}". Se perderán si sales de PanDB. ¿Guardar antes de salir?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminado o movido fuera de PanDB",
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "PanDB no pudo identificar exactamente una tabla de destino segura para escribir este resultado.",
      ...
      "metadata-unavailable": "PanDB no pudo cargar los metadatos de la tabla, por lo que la edición de resultados está deshabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "La importación cifrada no está disponible en este navegador. Usa HTTPS, localhost o PanDB Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Se requiere PanDB MCP Server",
    codexMcpRequiredDescription: "Codex CLI usa PanDB MCP Server para acceder al esquema de la base de datos y a las herramientas de consulta. Instálalo antes de usar Codex en el asistente de IA.",
    ...
    codexCliEnvReservedName: "{name} lo administra PanDB para MCP Server y no se puede configurar aquí.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por PanDB. Elimina las variables DBX_MCP_* de la configuración del proveedor.",
      ...
      claudeCodeMcpConfigInvalid: "Claude Code no pudo leer o analizar la configuración MCP de PanDB. Comprueba la versión y la ruta del ejecutable de Claude Code CLI.",
      dbxMcpMissing: "No se encontró una instalación compatible de PanDB MCP Server. Comprueba Configuración > MCP y vuelve a instalarla o actualizarla.",
      claudeCodeMcpStartupFailed: "Claude Code cargó la configuración MCP, pero no pudo iniciar PanDB MCP Server. Comprueba Configuración > MCP y los detalles siguientes.",
      claudeCodeCommandLineTooLong: "Windows rechazó el comando de Claude Code porque era demasiado largo. Actualiza PanDB y vuelve a intentarlo con el archivo MCP generado.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por PanDB. Elimina DBX_PI_* y DBX_MCP_* de la configuración.",
      ...
      piAgentMcpStartupFailed: "Pi no pudo iniciar el puente MCP de PanDB. Comprueba Configuración > MCP y los detalles siguientes.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Cuando DEFAULT está marcado, PanDB omite ese argumento para que la base de datos use el valor predeterminado.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "El estado del clúster sigue disponible. PanDB solicita /metrics directamente al endpoint de etcd actual; comprueba que la URL resultante sea accesible desde PanDB.",
  ...
  sqlParameters: {
    ...
    description: "Completa valores para marcadores de plantilla SQL. PanDB los reemplaza antes de ejecutar el SQL.",
    name: "Parámetro",
    syntax: "Sintaxis",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predeterminada de PanDB",
    ...
    iconThemeDefaultDescription: "Usar el icono de color de PanDB.",
    iconThemeBlack: "Negro",
    iconThemeBlackDescription: "Usa el logo negro de PanDB en la aplicación.",
    ...
    showTrayIconDescription: "Si está desactivado, no se muestra el icono, pero cerrar la ventana sigue ocultando PanDB en segundo plano como antes.",
    quitOnClose: "Salir al cerrar la ventana",
    quitOnCloseDescription: "Si está activado, al pulsar el botón de cerrar PanDB se cierra por completo en lugar de ocultarse en la bandeja.",
    ...
    closeActionQuit: "Salir de PanDB",
    closeActionMinimize: "Minimizar a la bandeja",
    updateNotificationsEnabled: "Activar recordatorios de actualización",
    updateNotificationsEnabledDescription: "Al desactivarlo, PanDB no comprobará automáticamente actualizaciones de la app ni de los controladores, ni mostrará indicadores. Las comprobaciones manuales siguen disponibles.",
    ...
    duckDbWorkerProcessIsolationDescription: "Ejecuta las consultas de DuckDB en un proceso worker independiente. Si una consulta larga no responde a la cancelación, PanDB puede detener el proceso worker para liberar el bloqueo del archivo de base de datos.",
    duckDbWorkerMaxProcesses: "Workers concurrentes máximos de DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita cuántos procesos worker de DuckDB puede ejecutar PanDB al mismo tiempo. Rango: 1-16. Predeterminado: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicia PanDB para que este cambio surta efecto.",
    restartDbx: "Reiniciar PanDB",
    restartDbxFailed: "No se pudo reiniciar PanDB: {error}",
    ...
    openTabsRestoreModeDescription: "Elige cómo PanDB restaura las pestañas que estaban abiertas la última vez.",
    ...
    syncWebDavDescription: "Sube o restaura una instantánea de PanDB, incluida la biblioteca SQL guardada, desde almacenamiento compatible con WebDAV.",
    ...
    syncRemotePathDescription: "PanDB creará las carpetas padre faltantes al subir.",
    syncSecretNotice: "De forma predeterminada, PanDB solo sincroniza detalles de conexión y ajustes. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales.",
    syncSecrets: "Sincronizar secretos cifrados",
    syncSecretsDescription: "Al activarlo, PanDB cifra contraseñas de base de datos, contraseñas SSH y API keys de IA antes de subirlas a WebDAV.",
    syncSecretsPassphrase: "Contraseña de sync",
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. PanDB no la guarda; tendrás que ingresarla en cada dispositivo.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    syncAutoUploadDescription: "Se ejecuta mientras PanDB está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar SQL guardado localmente.",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de PanDB? Se reemplazarán metadatos locales y SQL guardado.",
    apply: "Aplicar",
    ...
    sqlVariableSyntaxDescription: "Elige qué sintaxis de variables y marcadores sustituye PanDB antes de ejecutar SQL, por tipo de base de datos. Todas están habilitadas de forma predeterminada.",
    ...
    jdbcPlugin: "Plugin JDBC de PanDB",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Comprueba la instalación y versión de PanDB MCP Server para Claude Code, Cursor y otros agentes.",
    ...
    mcpConfigOptionsHint:
      "PanDB controla de forma central el acceso a conexiones y los permisos de ejecución para todos los clientes MCP. La configuración generada solo contiene los parámetros de ejecución necesarios para iniciar el servidor MCP y conectarlo a esta instancia de PanDB, sin variables de permisos ni de ámbito de conexión.",
    mcpScopeConnection: "Conexiones permitidas para MCP",
    mcpScopeConnectionDescription: "PanDB solo expone a MCP las conexiones seleccionadas. Los cambios se aplican a todos los clientes MCP.",
    ...
    mcpExecutionModeDescription: "Elige el nivel de permiso que PanDB aplica a todos los clientes MCP. La configuración de lectura y escritura del cliente no puede cambiar este nivel.",
    ...
    mcpExecutionModeReadOnlyDescription: "Solo permite solicitudes que PanDB clasifica como lecturas; bloquea las escrituras reconocidas y los cambios de conexión. Los permisos de la cuenta de base de datos siguen siendo el límite de seguridad final.",
    ...
    mcpCapabilityDescription: "Estas son operaciones representativas; las solicitudes que PanDB no puede clasificar de forma fiable requieren acceso completo.",
    ...
    mcpDetectionTiming: "PanDB comprueba automáticamente al abrir esta página; usa Comprobar de nuevo para actualizar.",
    mcpNpmBoundary: "PanDB solo comprueba y explica el estado de MCP; la instalación y actualización siguen usando npm.",
    ...
    supportInfoAppVersion: "Versión de PanDB",
    ...
    syncSnippetMigrateLegacyConfirm: "PanDB creará primero un reemplazo cifrado y después eliminará permanentemente el fragmento heredado de texto sin cifrar {id}. Esta acción no se puede deshacer. ¿Continuar?",
  ...
  driverStore: {
    ...
    javaRuntimeManaged: "JRE administrado por PanDB",
  ...
  nacos: {
    ...
    persistentInstanceHint: "PanDB no registra instancias efímeras porque no puede mantener sus latidos.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "PanDB ejecutará copias de seguridad programadas cuando esté abierto, incluso cuando esté minimizado en la bandeja.",
