...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Arch-GPT DB descargará el ZIP portable firmado, reemplazará solo Arch-GPT DB.exe después de salir y se reiniciará automáticamente. portable.pandb y data se conservarán.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por Arch-GPT DB. Elimina las variables DBX_MCP_* de la configuración del proveedor.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por Arch-GPT DB. Elimina DBX_PI_* y DBX_MCP_* de la configuración.",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. Arch-GPT DB no la guarda; tendrás que ingresarla en cada dispositivo.",
    syncTest: "Probar",
    syncUpload: "Subir",
