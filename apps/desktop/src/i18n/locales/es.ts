...
export default withEnglishFallback({
  ...
  externalSqlFile: {
    modifiedTitle: "El archivo cambió fuera de Arch-GPT DB",
    ...
    deletedDescription: "{path} fue eliminado o movido fuera de Arch-GPT DB. El contenido del editor sigue disponible.",
  ...
  updates: {
    ...
    availableMessage: "Arch-GPT DB {latest} está disponible. Estás usando la versión {current}.",
    upToDate: "Arch-GPT DB está actualizado ({version}).",
    ...
    activeTasksBlockUpdate: "Hay {count} tarea(s) en ejecución. Espera a que terminen antes de actualizar Arch-GPT DB.",
    portableAutomaticUpdate: "Arch-GPT DB descargará el ZIP portable firmado, reemplazará solo Arch-GPT DB.exe después de salir y se reiniciará automáticamente. portable.dbx y data se conservarán.",
  ...
  sidebar: {
    ...
    importDbx: "Importar configuración Arch-GPT DB",
  ...
  sqlLibrary: {
    ...
    storageHelp: "El contenido de la Biblioteca SQL se guarda en los datos de la aplicación Arch-GPT DB, no como archivos .sql independientes en el disco.\nPara usarlo en el sistema de archivos, exporta la Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, pero Arch-GPT DB no pudo recordar la contraseña: {message}",
    ...
    oracleTnsPathHint: "La ruta la lee el backend de Arch-GPT DB/Oracle Agent. En escritorio es local; en Web y Docker pertenece al servidor.",
    ...
    gaussdbConnectionModeNativeHint: "Usa el protocolo compatible con PostgreSQL integrado en Arch-GPT DB para los modos A/PG/Oracle de GaussDB.",
    ...
    agentJavaTooOld: "Este controlador requiere Java 21. Use el JRE 21 administrado por Arch-GPT DB o seleccione un ejecutable Java 21 en el Administrador de controladores.",
    ...
    jdbcPluginHint: "Instala primero el plugin JDBC de Arch-GPT DB y luego importa el JAR del driver JDBC del proveedor.",
    ...
    kafkaKerberosKeytabPlaceholder: "Ruta en la máquina donde se ejecuta Arch-GPT DB Agent, por ejemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, ruta en la máquina donde se ejecuta Arch-GPT DB Agent, por ejemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Las rutas de keytab y krb5.conf son leídas por Arch-GPT DB Agent y deben existir en la máquina donde se ejecuta Arch-GPT DB Agent; no se subirán archivos desde el navegador actual.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} pestañas SQL que vas a cerrar tienen cambios sin guardar. Arch-GPT DB muestra actualmente "{title}". ¿Guardar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tiene cambios SQL sin guardar que se perderán si sales de Arch-GPT DB. ¿Guardar antes de salir?',
    unsavedChangesAppCloseMultipleMessage: '{count} pestañas SQL tienen cambios sin guardar. Arch-GPT DB muestra actualmente "{title}". Se perderán si sales de Arch-GPT DB. ¿Guardar antes de salir?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminado o movido fuera de Arch-GPT DB",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "Esta operación actualiza inmediatamente todas las filas que coincidan al ejecutarse, incluidas las no cargadas. Arch-GPT DB no puede generar una reversión fiable para ellas.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "Arch-GPT DB no pudo identificar exactamente una tabla de destino segura para escribir este resultado.",
      ...
      "metadata-unavailable": "Arch-GPT DB no pudo cargar los metadatos de la tabla, por lo que la edición de resultados está deshabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "La importación cifrada no está disponible en este navegador. Usa HTTPS, localhost o Arch-GPT DB Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Se requiere Arch-GPT DB MCP Server",
    codexMcpRequiredDescription: "Codex CLI usa Arch-GPT DB MCP Server para acceder al esquema de la base de datos y a las herramientas de consulta. Instálalo antes de usar Codex en el asistente de IA.",
    ...
    codexCliEnvReservedName: "{name} lo administra Arch-GPT DB para MCP Server y no se puede configurar aquí.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por Arch-GPT DB. Elimina las variables Arch-GPT DB_MCP_* de la configuración del proveedor.",
      ...
      claudeCodeMcpConfigInvalid: "Claude Code no pudo leer o analizar la configuración MCP de Arch-GPT DB. Comprueba la versión y la ruta del ejecutable de Claude Code CLI.",
      dbxMcpMissing: "No se encontró una instalación compatible de Arch-GPT DB MCP Server. Comprueba Configuración > MCP y vuelve a instalarla o actualizarla.",
      claudeCodeMcpStartupFailed: "Claude Code cargó la configuración MCP, pero no pudo iniciar Arch-GPT DB MCP Server. Comprueba Configuración > MCP y los detalles siguientes.",
      claudeCodeCommandLineTooLong: "Windows rechazó el comando de Claude Code porque era demasiado largo. Actualiza Arch-GPT DB y vuelve a intentarlo con el archivo MCP generado.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por Arch-GPT DB. Elimina Arch-GPT DB_PI_* y Arch-GPT DB_MCP_* de la configuración.",
      ...
      piAgentMcpStartupFailed: "Pi no pudo iniciar el puente MCP de Arch-GPT DB. Comprueba Configuración > MCP y los detalles siguientes.",
      ...
      openCodeEnvReserved: "Se intentó sobrescribir una variable administrada por OpenCode o Arch-GPT DB. Elimina las variables de control OPENCODE y Arch-GPT DB_MCP_* de la configuración.",
      ...
      openCodeMcpStartupFailed: "OpenCode no pudo iniciar el servidor Arch-GPT DB MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      cursorEnvReserved: "Se intentó sobrescribir una variable administrada por Cursor o Arch-GPT DB. Elimina CURSOR_CONFIG_DIR, CURSOR_DATA_DIR y Arch-GPT DB_MCP_* de la configuración.",
      cursorNotAuthenticated: "Cursor CLI no está autenticado. Ejecuta `agent login` en una terminal y vuelve a intentarlo.",
      cursorMcpStartupFailed: "Cursor no pudo iniciar el servidor Arch-GPT DB MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      grokCliEnvReserved: "Se sobrescribió una variable MCP gestionada por Arch-GPT DB. Elimina las variables Arch-GPT DB_MCP_* de la configuración del proveedor.",
      grokCliNotAuthenticated: "Grok CLI no está autenticado. Ejecuta `grok login` en una terminal e inténtalo de nuevo.",
      grokCliMcpStartupFailed: "Grok cargó la configuración MCP pero no pudo iniciar Arch-GPT DB MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      grokCliCommandLineTooLong: "Windows rechazó el comando de Grok CLI porque era demasiado largo. Actualiza Arch-GPT DB y vuelve a intentarlo con el archivo de prompt generado.",
      ...
      codeBuddyEnvReserved: "Se sobrescribió una variable MCP gestionada por Arch-GPT DB. Elimina las variables Arch-GPT DB_MCP_* de la configuración del proveedor.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code no pudo leer la configuración temporal de Arch-GPT DB MCP. Revisa los diagnósticos siguientes.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code cargó la configuración MCP pero no pudo iniciar Arch-GPT DB MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      ...
      qoderEnvReserved: "Se sobrescribió una variable de entorno MCP administrada por Arch-GPT DB. Elimina las variables Arch-GPT DB_MCP_* de la configuración del proveedor.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI no pudo leer la configuración MCP temporal de Arch-GPT DB. Comprueba la versión de Qoder CLI y los diagnósticos siguientes.",
      qoderMcpStartupFailed: "Qoder CLI cargó la configuración MCP, pero no pudo iniciar Arch-GPT DB MCP Server. Comprueba Configuración > MCP y los diagnósticos siguientes.",
    ...
    closeWithRunsDescription: "Salir de Arch-GPT DB interrumpirá {count} tarea(s) de AI en ejecución o en cola. También puedes cerrar este diálogo y dejar que terminen.",
    ...
    productionWriteBlocked: "La IA no puede ejecutar cambios de datos o esquema en una base de datos de producción. Revisa este SQL y ejecútalo manualmente en Arch-GPT DB.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Cuando DEFAULT está marcado, Arch-GPT DB omite ese argumento para que la base de datos use el valor predeterminado.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "El estado del clúster sigue disponible. Arch-GPT DB solicita /metrics directamente al endpoint de etcd actual; comprueba que la URL resultante sea accesible desde Arch-GPT DB.",
  ...
  sqlParameters: {
    ...
    description: "Completa valores para marcadores de plantilla SQL. Arch-GPT DB los reemplaza antes de ejecutar el SQL.",
    name: "Parámetro",
    syntax: "Sintaxis",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predeterminada de Arch-GPT DB",
    ...
    iconThemeDefaultDescription: "Usar el icono de color de Arch-GPT DB.",
    iconThemeBlack: "Negro",
    iconThemeBlackDescription: "Usa el logo negro de Arch-GPT DB en la aplicación.",
    ...
    showTrayIconDescription: "Si está desactivado, no se muestra el icono, pero cerrar la ventana sigue ocultando Arch-GPT DB en segundo plano como antes.",
    quitOnClose: "Salir al cerrar la ventana",
    quitOnCloseDescription: "Si está activado, al pulsar el botón de cerrar Arch-GPT DB se cierra por completo en lugar de ocultarse en la bandeja.",
    ...
    closeActionQuit: "Salir de Arch-GPT DB",
    closeActionMinimize: "Minimizar a la bandeja",
    updateNotificationsEnabled: "Activar recordatorios de actualización",
    updateNotificationsEnabledDescription: "Al desactivarlo, Arch-GPT DB no comprobará automáticamente actualizaciones de la app ni de los controladores, ni mostrará indicadores. Las comprobaciones manuales siguen disponibles.",
    ...
    duckDbWorkerProcessIsolationDescription: "Ejecuta las consultas de DuckDB en un proceso worker independiente. Si una consulta larga no responde a la cancelación, Arch-GPT DB puede detener el proceso worker para liberar el bloqueo del archivo de base de datos.",
    duckDbWorkerMaxProcesses: "Workers concurrentes máximos de DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita cuántos procesos worker de DuckDB puede ejecutar Arch-GPT DB al mismo tiempo. Rango: 1-16. Predeterminado: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicia Arch-GPT DB para que este cambio surta efecto.",
    restartDbx: "Reiniciar Arch-GPT DB",
    restartDbxFailed: "No se pudo reiniciar Arch-GPT DB: {error}",
    ...
    openTabsRestoreModeDescription: "Elige cómo Arch-GPT DB restaura las pestañas que estaban abiertas la última vez.",
    ...
    syncWebDavDescription: "Sube o restaura una instantánea de Arch-GPT DB, incluida la biblioteca SQL guardada, desde almacenamiento compatible con WebDAV.",
    syncWebDavWebDescription: "En modo Web, el servidor Arch-GPT DB accede a WebDAV sin las restricciones CORS del navegador. Las contraseñas guardadas permanecen en la instancia Arch-GPT DB actual.",
    ...
    syncRememberWebDavPasswordDescription: "La contraseña se cifra y se guarda solo en la instancia Arch-GPT DB actual. No se sincroniza a WebDAV ni reemplaza la contraseña de sync.",
    syncRemotePath: "Ruta remota",
    syncRemotePathDescription: "Arch-GPT DB creará las carpetas padre faltantes al subir.",
    syncSecretNotice: "De forma predeterminada, Arch-GPT DB solo sincroniza detalles de conexión y ajustes. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales.",
    syncSecrets: "Sincronizar secretos cifrados",
    syncSecretsDescription: "Al activarlo, Arch-GPT DB cifra contraseñas de base de datos, contraseñas SSH y API keys de IA antes de subirlas a WebDAV.",
    syncSecretsPassphrase: "Contraseña de sync",
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. Se cifra en la instancia Arch-GPT DB actual; vuelve a ingresarla en otras instancias.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    syncAutoUploadDescription: "Se ejecuta mientras Arch-GPT DB está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar SQL guardado localmente.",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de Arch-GPT DB? Se reemplazarán metadatos locales y SQL guardado.",
    apply: "Aplicar",
    ...
    appCloseUnsavedTabsModeDescription: "Elige qué ocurre al salir de Arch-GPT DB con pestañas SQL que tienen ediciones sin guardar.",
    appCloseUnsavedTabsModePrompt: "Preguntar si guardar",
    appCloseUnsavedTabsModeKeepDrafts: "Salir y conservar borradores",
    appCloseUnsavedTabsModeHint: 'Los borradores se conservan como pestañas sin guardar y se restauran la próxima vez que inicies Arch-GPT DB. Requiere que "Restaurar pestañas al iniciar" no esté en "No conservar pestañas".',
    appCloseDraftPersistFailed: "Arch-GPT DB no pudo guardar los borradores de las pestañas abiertas, por lo que se canceló la salida. Comprueba el espacio en disco y los permisos de los archivos, y vuelve a intentarlo. Detalles: {message}",
    ...
    sqlVariableSyntaxDescription: "Elige qué sintaxis de variables y marcadores sustituye Arch-GPT DB antes de ejecutar SQL, por tipo de base de datos. Todas están habilitadas de forma predeterminada.",
    ...
    jdbcPlugin: "Plugin JDBC de Arch-GPT DB",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Comprueba la instalación y versión de Arch-GPT DB MCP Server para Claude Code, Cursor y otros agentes.",
    ...
    mcpConfigOptionsHint:
      "Arch-GPT DB controla de forma central el acceso a conexiones y los permisos de ejecución para todos los clientes MCP. La configuración generada solo contiene los parámetros de ejecución necesarios para iniciar el servidor MCP y conectarlo a esta instancia de Arch-GPT DB, sin variables de permisos ni de ámbito de conexión.",
    mcpScopeConnection: "Conexiones permitidas para MCP",
    mcpScopeConnectionDescription: "Arch-GPT DB solo expone a MCP las conexiones seleccionadas. Los cambios se aplican a todos los clientes MCP.",
    ...
    mcpExecutionModeDescription: "Elige el nivel de permiso que Arch-GPT DB aplica a todos los clientes MCP. La configuración de lectura y escritura del cliente no puede cambiar este nivel.",
    ...
    mcpExecutionModeReadOnlyDescription: "Solo permite solicitudes que Arch-GPT DB clasifica como lecturas; bloquea las escrituras reconocidas y los cambios de conexión. Los permisos de la cuenta de base de datos siguen siendo el límite de seguridad final.",
    ...
    mcpCapabilityDescription: "Estas son operaciones representativas; las solicitudes que Arch-GPT DB no puede clasificar de forma fiable requieren acceso completo.",
    ...
    mcpDetectionTiming: "Arch-GPT DB comprueba automáticamente al abrir esta página; usa Comprobar de nuevo para actualizar.",
    mcpNpmBoundary: "Arch-GPT DB solo comprueba y explica el estado de MCP; la instalación y actualización siguen usando npm.",
    ...
    supportInfoAppVersion: "Versión de Arch-GPT DB",
    ...
    syncSnippetMigrateLegacyConfirm: "Arch-GPT DB creará primero un reemplazo cifrado y después eliminará permanentemente el fragmento heredado de texto sin cifrar {id}. Esta acción no se puede deshacer. ¿Continuar?",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Selecciona los drivers Agent administrados por Arch-GPT DB que se incluirán. El paquete solo es compatible con la plataforma actual.",
    ...
    offlineExportNoDrivers: "No hay drivers Agent administrados por Arch-GPT DB que se puedan exportar.",
    ...
    offlineExportSecurityHint: "Solo se incluyen artefactos administrados por Arch-GPT DB y los JRE necesarios. Se excluyen rutas locales, configuraciones y drivers externos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "El artefacto no está registrado como una instalación administrada por Arch-GPT DB.",
    ...
    offlineExportUnavailable_missingManagedJre: "El JRE administrado por Arch-GPT DB requerido no está instalado.",
    offlineExportUnavailable_invalidManagedJre: "El JRE administrado por Arch-GPT DB requerido no es válido o no es seguro.",
    refresh: "Actualizar",
    javaRuntime: "Runtime Java",
    javaRuntimeManaged: "JRE administrado por Arch-GPT DB",
    ...
    localInstallHint: "Para entornos sin acceso a internet: en otro equipo con conexión, descarga el dbx-jdbc-plugin-*.zip oficial desde la página de Releases de Arch-GPT DB en GitHub, transfiérelo a esta máquina y selecciónalo; no se necesita acceso a la red en este equipo.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Déjalo vacío para que Arch-GPT DB genere un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "Arch-GPT DB verifica el acceso de lectura a configuraciones y servicios antes de ofrecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexión usa la API Console de Nacos 3 (normalmente el puerto 8080). Introduce un nombre o ID de namespace; Arch-GPT DB convierte el nombre al ID real cuando puede leer el directorio.",
    ...
    persistentInstanceHint: "Arch-GPT DB no registra instancias efímeras porque no puede mantener sus latidos.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "Arch-GPT DB ejecutará copias de seguridad programadas cuando esté abierto, incluso cuando esté minimizado en la bandeja.",
