...
export default withEnglishFallback({
  ...
  externalSqlFile: {
    modifiedTitle: "File modificato esternamente a Arch-GPT DB",
    ...
    deletedDescription: "{path} è stato eliminato o spostato fuori da Arch-GPT DB. Il contenuto dell'editor è ancora disponibile.",
  ...
  updates: {
    ...
    availableMessage: "Arch-GPT DB {latest} è disponibile. Stai usando la versione {current}.",
    upToDate: "Arch-GPT DB è aggiornato ({version}).",
    ...
    activeTasksBlockUpdate: "Ci sono {count} attività in esecuzione. Attendi che terminino prima di aggiornare Arch-GPT DB.",
    portableAutomaticUpdate: "Arch-GPT DB scaricherà lo ZIP portatile firmato, sostituirà solo Arch-GPT DB.exe dopo l'uscita e si riavvierà automaticamente. portable.dbx e i dati verranno mantenuti.",
  ...
  sidebar: {
    ...
    importDbx: "Importa Configurazione Arch-GPT DB",
  ...
  sqlLibrary: {
    title: "Libreria SQL",
    storageHelp: "Il contenuto della Libreria SQL viene salvato nei dati dell'app Arch-GPT DB, non come file .sql autonomi sul disco.\nPer usarlo nel file system, esporta la Libreria SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connessione riuscita, ma Arch-GPT DB non ha potuto memorizzare la password: {message}",
    ...
    oracleTnsPathHint: "Il percorso viene letto dal backend Arch-GPT DB/Oracle Agent. Sul desktop è locale; su Web e Docker appartiene al server.",
    ...
    gaussdbConnectionModeNativeHint: "Usa il protocollo compatibile con PostgreSQL integrato in Arch-GPT DB per le modalità A/PG/Oracle di GaussDB.",
    ...
    agentJavaTooOld: "Questo driver richiede Java 21. Usa il JRE 21 gestito da Arch-GPT DB o seleziona un eseguibile Java 21 in Gestione Driver.",
    ...
    jdbcPluginHint: "Installa prima il plugin Arch-GPT DB JDBC, quindi importa il file JAR del driver JDBC del fornitore del database.",
    ...
    kafkaKerberosKeytabPlaceholder: "Percorso sulla macchina Arch-GPT DB Agent, ad esempio /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opzionale, percorso sulla macchina Arch-GPT DB Agent, ad esempio /etc/krb5.conf",
    kafkaKerberosPathHint: "I percorsi di keytab e krb5.conf vengono letti da Arch-GPT DB Agent e devono esistere sulla macchina in cui è in esecuzione Arch-GPT DB Agent; non vengono caricati file dal browser corrente.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} schede SQL che stai chiudendo hanno modifiche non salvate. Arch-GPT DB mostra attualmente "{title}". Salvare prima di continuare?',
    unsavedChangesAppCloseMessage: '"{title}" ha modifiche SQL non salvate che andranno perse se esci da Arch-GPT DB. Salvare prima di uscire?',
    unsavedChangesAppCloseMultipleMessage: '{count} schede SQL hanno modifiche non salvate. Arch-GPT DB mostra attualmente "{title}". Andranno perse se esci da Arch-GPT DB. Salvare prima di uscire?',
  ...
  tabs: {
    ...
    externalFileMissing: "Eliminato o spostato fuori da Arch-GPT DB",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "L'operazione aggiorna immediatamente tutte le righe corrispondenti al momento dell'esecuzione, incluse quelle non caricate. Arch-GPT DB non può generare un rollback affidabile.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "Arch-GPT DB could not identify exactly one safe writeback target table for this result.",
      ...
      "metadata-unavailable": "Arch-GPT DB could not load table metadata, so result editing is disabled.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "L'importazione cifrata non è disponibile in questo contesto del browser. Usa HTTPS, localhost o Arch-GPT DB Desktop.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Uscire da Arch-GPT DB interromperà {count} attività di AI in esecuzione o in coda. Puoi anche chiudere questa finestra e lasciarle terminare.",
    ...
    productionWriteBlocked: "L'AI non può eseguire modifiche a dati o schema su un database di produzione. Rivedi questo SQL ed eseguilo manualmente in Arch-GPT DB.",
    ...
    codexCliEnvReservedName: "{name} è gestita da Arch-GPT DB per MCP Server e non può essere impostata qui.",
    cliMcpRequiredTitle: "Arch-GPT DB MCP Server required",
    cliMcpRequiredDescription: "{provider} uses the Arch-GPT DB MCP Server to access database schema and query tools. Install it before using this provider in the AI assistant.",
    ...
    cliEnvReservedName: "{name} is managed by Arch-GPT DB for the MCP server and cannot be set here.",
    codexMcpRequiredTitle: "Arch-GPT DB MCP Server richiesto",
    codexMcpRequiredDescription: "Codex CLI usa il Arch-GPT DB MCP Server per accedere allo schema del database e agli strumenti di query. Installalo prima di usare Codex nell'assistente AI.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da Arch-GPT DB. Rimuovi le variabili Arch-GPT DB_MCP_* dalla configurazione del provider.",
      claudeCodeNotAuthenticated: "Claude Code CLI non è autenticato. Esegui `claude auth login` in un terminale e riprova.",
      claudeCodeMcpConfigInvalid: "Claude Code non ha potuto leggere o analizzare la configurazione MCP di Arch-GPT DB. Controlla la versione e il percorso di Claude Code CLI.",
      dbxMcpMissing: "Non è stata trovata un'installazione compatibile di Arch-GPT DB MCP Server. Controlla Impostazioni > MCP, quindi reinstalla o aggiorna.",
      claudeCodeMcpStartupFailed: "Claude Code ha caricato la configurazione MCP ma non ha potuto avviare Arch-GPT DB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      claudeCodeCommandLineTooLong: "Windows ha rifiutato il comando Claude Code perché troppo lungo. Aggiorna Arch-GPT DB e riprova usando il file MCP generato.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da Arch-GPT DB. Rimuovi Arch-GPT DB_PI_* e Arch-GPT DB_MCP_* dalla configurazione.",
      ...
      piAgentMcpStartupFailed: "Pi non ha potuto avviare il bridge MCP Arch-GPT DB. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      openCodeEnvReserved: "È stata sovrascritta una variabile gestita da OpenCode o Arch-GPT DB. Rimuovi le variabili di controllo OPENCODE e Arch-GPT DB_MCP_* dalla configurazione.",
      ...
      openCodeMcpStartupFailed: "OpenCode non ha potuto avviare il server Arch-GPT DB MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      cursorEnvReserved: "È stata sovrascritta una variabile gestita da Cursor o Arch-GPT DB. Rimuovi CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e Arch-GPT DB_MCP_* dalla configurazione.",
      cursorNotAuthenticated: "Cursor CLI non è autenticato. Esegui `agent login` nel terminale e riprova.",
      cursorMcpStartupFailed: "Cursor non ha potuto avviare il server Arch-GPT DB MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      grokCliEnvReserved: "È stata sovrascritta una variabile MCP gestita da Arch-GPT DB. Rimuovi le variabili Arch-GPT DB_MCP_* dalla configurazione del provider.",
      grokCliNotAuthenticated: "Grok CLI non è autenticato. Esegui `grok login` in un terminale e riprova.",
      grokCliMcpStartupFailed: "Grok ha caricato la configurazione MCP ma non ha potuto avviare Arch-GPT DB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      grokCliCommandLineTooLong: "Windows ha rifiutato il comando Grok CLI perché troppo lungo. Aggiorna Arch-GPT DB e riprova usando il file di prompt generato.",
      ...
      codeBuddyEnvReserved: "È stata sovrascritta una variabile MCP gestita da Arch-GPT DB. Rimuovi le variabili Arch-GPT DB_MCP_* dalla configurazione del provider.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code non ha potuto leggere la configurazione temporanea di Arch-GPT DB MCP. Controlla i dettagli seguenti.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code ha caricato la configurazione MCP ma non ha potuto avviare Arch-GPT DB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      qoderEnvReserved: "È stata sovrascritta una variabile di ambiente MCP gestita da Arch-GPT DB. Rimuovi le variabili Arch-GPT DB_MCP_* dalla configurazione del provider.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI non ha potuto leggere la configurazione MCP temporanea di Arch-GPT DB. Controlla la versione di Qoder CLI e i dettagli seguenti.",
      qoderMcpStartupFailed: "Qoder CLI ha caricato la configurazione MCP ma non ha potuto avviare Arch-GPT DB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT è selezionato, Arch-GPT DB omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Lo stato del cluster resta disponibile. Arch-GPT DB richiede /metrics direttamente all'endpoint etcd corrente; verifica che l'URL risultante sia raggiungibile dall'applicazione Arch-GPT DB.",
  ...
  sqlParameters: {
    title: "Parametri SQL",
    description: "Compila i valori per i segnaposto del template SQL. Arch-GPT DB li sostituisce prima di eseguire l'SQL.",
    name: "Parametro",
    syntax: "Sintassi",
    type: "Tipo",
    value: "Valore",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predefinito Arch-GPT DB",
    ...
    iconThemeDefaultDescription: "Utilizza l'icona colorata dell'app Arch-GPT DB.",
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Usa il logo Arch-GPT DB nero nell'app.",
    ...
    showTrayIconDescription: "Se disattivato, non viene mostrata alcuna icona, ma la chiusura della finestra nasconderà comunque Arch-GPT DB in background.",
    quitOnClose: "Esci alla chiusura della finestra",
    quitOnCloseDescription: "Se attivato, il pulsante di chiusura termina completamente Arch-GPT DB invece di nasconderlo nella barra delle applicazioni.",
    ...
    closeActionQuit: "Esci da Arch-GPT DB",
    closeActionMinimize: "Riduci a icona",
    updateNotificationsEnabled: "Abilita promemoria aggiornamenti",
    updateNotificationsEnabledDescription: "Se disattivato, Arch-GPT DB non controllerà automaticamente gli aggiornamenti dell'app o dei driver e non mostrerà badge. I controlli manuali restano disponibili.",
    ...
    duckDbWorkerProcessIsolationDescription: "Esegue le query DuckDB in un processo worker separato. Se una query lunga non risponde all'annullamento, Arch-GPT DB può arrestare il processo worker per rilasciare il blocco del file di database.",
    duckDbWorkerMaxProcesses: "Worker DuckDB simultanei massimi",
    duckDbWorkerMaxProcessesDescription: "Limita quanti processi worker DuckDB Arch-GPT DB può eseguire contemporaneamente. Intervallo: 1-16. Predefinito: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Riavvia Arch-GPT DB affinché questa modifica abbia effetto.",
    restartDbx: "Riavvia Arch-GPT DB",
    restartDbxFailed: "Impossibile riavviare Arch-GPT DB: {error}",
    ...
    openTabsRestoreModeDescription: "Scegli come Arch-GPT DB ripristina le schede aperte l'ultima volta.",
    ...
    syncWebDavDescription: "Carica o ripristina uno snapshot di Arch-GPT DB, inclusa la libreria SQL salvata, da un servizio di archiviazione compatibile con WebDAV.",
    syncWebDavWebDescription: "In modalità Web, il server Arch-GPT DB accede a WebDAV senza le limitazioni CORS del browser. Le password salvate restano nell'istanza Arch-GPT DB corrente.",
    ...
    syncRememberWebDavPasswordDescription: "La password viene crittografata e memorizzata solo nell'istanza Arch-GPT DB corrente. Non viene sincronizzata su WebDAV e non sostituisce la password di sincronizzazione.",
    syncRemotePath: "Percorso snapshot remoto",
    syncRemotePathDescription: "Arch-GPT DB creerà le cartelle superiori mancanti durante il caricamento.",
    syncSecretNotice: "Per impostazione predefinita, Arch-GPT DB sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription: "Se abilitato, Arch-GPT DB crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. È crittografata nell'istanza Arch-GPT DB corrente; inseriscila di nuovo nelle altre istanze.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncAutoUploadDescription: "Viene eseguito mentre Arch-GPT DB è aperto. I download richiedono ancora conferma manuale per evitare di sostituire SQL salvati localmente.",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot Arch-GPT DB remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    appCloseUnsavedTabsModeDescription: "Scegli cosa succede quando esci da Arch-GPT DB con schede SQL che contengono modifiche non salvate.",
    appCloseUnsavedTabsModePrompt: "Chiedi se salvare",
    appCloseUnsavedTabsModeKeepDrafts: "Esci e conserva le bozze",
    appCloseUnsavedTabsModeHint: 'Le bozze vengono conservate come schede non salvate e ripristinate al prossimo avvio di Arch-GPT DB. Richiede che "Ripristina schede all\'avvio" non sia impostato su "Non mantenere schede".',
    appCloseDraftPersistFailed: "Arch-GPT DB non ha potuto salvare le bozze delle schede aperte, quindi l'uscita è stata annullata. Controlla lo spazio su disco e i permessi dei file, quindi riprova. Dettagli: {message}",
    ...
    sqlVariableSyntaxDescription: "Scegli quali sintassi di variabili e segnaposto Arch-GPT DB sostituisce prima di eseguire SQL, per tipo di database. Tutte abilitate per impostazione predefinita.",
    ...
    jdbcPlugin: "Plugin Arch-GPT DB JDBC",
    ...
    mcpTitle: "Server MCP",
    mcpDescription: "Verifica l'installazione e la versione del Server Arch-GPT DB MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpConfigOptionsHint:
      "Arch-GPT DB controlla centralmente l'accesso alle connessioni e i permessi di esecuzione per tutti i client MCP. La configurazione generata contiene solo i parametri di runtime necessari per avviare il server MCP e collegarlo a questa istanza Arch-GPT DB, senza variabili di autorizzazione o ambito connessione.",
    mcpScopeConnection: "Connessioni consentite per MCP",
    mcpScopeConnectionDescription: "Arch-GPT DB espone a MCP solo le connessioni selezionate. Le modifiche si applicano a tutti i client MCP.",
    ...
    mcpExecutionModeDescription: "Scegli il livello di autorizzazione applicato da Arch-GPT DB a tutti i client MCP. Le impostazioni di lettura e scrittura del client non possono modificare questo livello.",
    ...
    mcpExecutionModeReadOnlyDescription: "Consente solo le richieste che Arch-GPT DB classifica come letture; blocca le scritture riconosciute e le modifiche alle connessioni. I permessi dell'account del database restano il limite di sicurezza finale.",
    ...
    mcpCapabilityDescription: "Queste sono operazioni rappresentative; le richieste che Arch-GPT DB non può classificare in modo affidabile richiedono l'accesso completo.",
    ...
    mcpDetectionTiming: "Arch-GPT DB esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary: "Arch-GPT DB verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
    ...
    supportInfoAppVersion: "Versione Arch-GPT DB",
    ...
    syncSnippetMigrateLegacyConfirm: "Arch-GPT DB creerà prima una sostituzione crittografata, quindi eliminerà definitivamente lo snippet legacy in testo semplice {id}. L'operazione non può essere annullata. Continuare?",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Seleziona i driver Agent gestiti da Arch-GPT DB da includere. Il pacchetto è compatibile solo con la piattaforma corrente.",
    ...
    offlineExportNoDrivers: "Non sono installati driver Agent gestiti da Arch-GPT DB idonei all'esportazione.",
    ...
    offlineExportSecurityHint: "Sono inclusi solo gli artefatti gestiti da Arch-GPT DB e i JRE necessari. Percorsi locali, impostazioni e driver esterni sono esclusi.",
    ...
    offlineExportUnavailable_unmanagedInstall: "L'artefatto non è registrato come installazione gestita da Arch-GPT DB.",
    ...
    offlineExportUnavailable_missingManagedJre: "Il JRE gestito da Arch-GPT DB richiesto non è installato.",
    offlineExportUnavailable_invalidManagedJre: "Il JRE gestito da Arch-GPT DB richiesto non è valido o sicuro.",
    refresh: "Aggiorna",
    javaRuntime: "Java Runtime",
    javaRuntimeManaged: "JRE gestito da Arch-GPT DB",
    ...
    localInstallHint:
      "Per ambienti completamente isolati: su un altro computer con accesso a internet, scarica il pacchetto ufficiale dbx-jdbc-plugin-*.zip dalla pagina Releases di Arch-GPT DB su GitHub, trasferiscilo su questa macchina e selezionalo: non è richiesto alcun accesso alla rete su questa macchina.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Lascia vuoto per far generare a Arch-GPT DB un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "Arch-GPT DB verifica la lettura di configurazioni e servizi prima di proporre i namespace per {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Questa connessione usa l'API Console di Nacos 3 (normalmente porta 8080). Inserisci un nome o ID namespace; Arch-GPT DB converte il nome nell'ID effettivo quando puo leggere la directory.",
    ...
    persistentInstanceHint: "Arch-GPT DB non registra istanze effimere perché non può mantenerne l'heartbeat.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "I backup programmati vengono eseguiti quando Arch-GPT DB è aperto, anche se ridotto a icona nella barra delle applicazioni.",
