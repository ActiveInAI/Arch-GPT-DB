...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Arch-GPT DB scaricherà lo ZIP portatile firmato, sostituirà solo Arch-GPT DB.exe dopo l'uscita e si riavvierà automaticamente. portable.pandb e i dati verranno mantenuti.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da Arch-GPT DB. Rimuovi le variabili DBX_MCP_* dalla configurazione del provider.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da Arch-GPT DB. Rimuovi DBX_PI_* e DBX_MCP_* dalla configurazione.",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. Arch-GPT DB non la salva; inseriscila nuovamente su ciascun dispositivo.",
    syncTest: "Verifica",
    syncUpload: "Carica",
