...
export default {
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Arch-GPT DB will download the signed portable ZIP, replace only Arch-GPT DB.exe after exit, and restart automatically. portable.pandb and data will be kept.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "A Arch-GPT DB-managed MCP environment variable was overridden. Remove DBX_MCP_* variables from the provider configuration.",
      ...
      piAgentEnvReserved: "A Arch-GPT DB-managed Pi or MCP environment variable was overridden. Remove DBX_PI_* and DBX_MCP_* variables from the provider configuration.",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "This password is only used to encrypt and restore sensitive data. Arch-GPT DB does not save it; enter it again on each device.",
    syncTest: "Test",
    syncUpload: "Upload",
    ...
    mcpNpmBoundary: "Arch-GPT DB only checks and explains MCP status; installation and upgrades still run through npm.",
