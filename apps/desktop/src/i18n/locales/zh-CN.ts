...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "Arch-GPT DB 将下载已签名的便携版 ZIP，退出后仅替换 Arch-GPT DB.exe 并自动重启。portable.pandb 和 data 会保留。",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "配置覆盖了由 Arch-GPT DB 管理的 MCP 环境变量。请从供应商配置中移除 DBX_MCP_* 变量。",
      ...
      piAgentEnvReserved: "配置覆盖了由 Arch-GPT DB 管理的 Pi 或 MCP 环境变量。请移除 DBX_PI_* 和 DBX_MCP_* 变量。",
  ...
  settings: {
    ...
    syncSecretsPassphraseDescription: "这个密码只用于加密和恢复敏感信息，Arch-GPT DB 不会保存；换设备恢复时需要再次输入。",
    syncTest: "测试",
    syncUpload: "上传",
    syncDownload: "下载",
    ...
    mcpNpmBoundary: "Arch-GPT DB 只检测和提示 MCP 状态；安装与升级仍由 npm 完成。",
    mcpRefresh: "重新检查",
    mcpGuide: "MCP 指南",
