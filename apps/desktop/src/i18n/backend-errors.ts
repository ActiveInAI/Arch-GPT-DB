...
const patterns: [RegExp, string][] = [
  ...
  [/^Agent requires Java 21, but Arch-GPT DB started it with an older Java runtime\. Use Arch-GPT DB managed JRE 21 or select a Java 21 executable in Driver Manager\./, "connection.agentJavaTooOld"],
