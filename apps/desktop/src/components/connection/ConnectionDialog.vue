...
const transportPathSegments = computed(() => {
  ...
  return ["PanDB", ...layers.map(transportLayerDisplayName), form.value.host || "Database"];
});
...
function connectionConfigForSubmit(id: string, generatedName = ""): ConnectionConfig {
  ...
  if (config.db_type === "oracle" && config.oracle_connection_type === "tns") {
    ...
    // Only clear PanDB-generated TNS URLs when switching modes; preserve custom
                  ...
                  <div class="grid grid-cols-4 items-start gap-4">
                    ...
                    <div class="col-span-3 space-y-2">
                      ...
                      <div class="flex flex-wrap gap-2">
                        ...
                        <Button type="button" variant="outline" size="sm" @click="openExternalUrl(activeJdbcProductProfile?.docsUrl || 'https://github.com/ActiveInAI/PanDB/tree/main/docs')">
                    ...
                    <div class="grid grid-cols-4 items-start gap-4">
                      ...
                      <div class="col-span-3 space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                          ...
                          <Button type="button" variant="outline" size="sm" @click="openExternalUrl('https://github.com/ActiveInAI/PanDB/tree/main/docs')">
                            <ExternalLink class="h-3.5 w-3.5" />
