...
if (isDebugLoggingEnabled()) {
  logDataGridTiming("[Arch-GPT DB][DataGrid:setup]", {
...
watch(
  ...
  (result) => {
    ...
    logDataGridTiming("[Arch-GPT DB][DataGrid:result:prop]", {
      traceId: dataGridTraceId,
      cacheKey: props.cacheKey,
    ...
    nextTick(() => {
      logDataGridTiming("[Arch-GPT DB][DataGrid:result:nextTick]", {
        traceId: dataGridTraceId,
        cacheKey: props.cacheKey,
      ...
      requestAnimationFrame(() => {
        logDataGridTiming("[Arch-GPT DB][DataGrid:result:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          elapsed: `${Math.round(performance.now() - startedAt)}ms`,
          loading: props.loading,
...
watch(
  ...
  (length) => {
    ...
    if (shouldLogTiming) {
      logDataGridTiming("[Arch-GPT DB][DataGrid:display-items:ready]", {
        traceId: dataGridTraceId,
        cacheKey: props.cacheKey,
    ...
    nextTick(() => {
      ...
      requestAnimationFrame(() => {
        ...
        logDataGridTiming("[Arch-GPT DB][DataGrid:display-items:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          displayItemCount: length,
          renderedRows,
...
watch(gridSurfaceBusy, (isLoading) => {
  stopLoadingElapsedTimer();
  if (isDebugLoggingEnabled()) {
    logDataGridTiming(isLoading ? "[Arch-GPT DB][DataGrid:loading:start]" : "[Arch-GPT DB][DataGrid:loading:stop]", {
      traceId: dataGridTraceId,
      cacheKey: props.cacheKey,
      elapsedSinceSetup: dataGridElapsed(),
    });
  ...
  if (isLoading) {
    ...
    nextTick(() => {
      requestAnimationFrame(() => {
        logDataGridTiming("[Arch-GPT DB][DataGrid:loading:stop:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          elapsedSinceSetup: dataGridElapsed(),
        });
