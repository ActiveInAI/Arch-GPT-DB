...
if (isDebugLoggingEnabled()) {
  logDataGridTiming("[PanDB][DataGrid:setup]", {
...
watch(
  ...
  (result) => {
    ...
    logDataGridTiming("[PanDB][DataGrid:result:prop]", {
      traceId: dataGridTraceId,
      cacheKey: props.cacheKey,
    ...
    nextTick(() => {
      logDataGridTiming("[PanDB][DataGrid:result:nextTick]", {
        traceId: dataGridTraceId,
        cacheKey: props.cacheKey,
      ...
      requestAnimationFrame(() => {
        logDataGridTiming("[PanDB][DataGrid:result:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          elapsed: `${Math.round(performance.now() - startedAt)}ms`,
          loading: props.loading,
...
watch(
  ...
  (length) => {
    ...
    if (shouldLogTiming) {
      logDataGridTiming("[PanDB][DataGrid:display-items:ready]", {
        traceId: dataGridTraceId,
        cacheKey: props.cacheKey,
    ...
    nextTick(() => {
      ...
      requestAnimationFrame(() => {
        ...
        logDataGridTiming("[PanDB][DataGrid:display-items:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          displayItemCount: length,
          renderedRows,
...
watch(gridSurfaceBusy, (isLoading) => {
  stopLoadingElapsedTimer();
  if (isDebugLoggingEnabled()) {
    logDataGridTiming(isLoading ? "[PanDB][DataGrid:loading:start]" : "[PanDB][DataGrid:loading:stop]", {
      traceId: dataGridTraceId,
      cacheKey: props.cacheKey,
      elapsedSinceSetup: dataGridElapsed(),
    });
  ...
  if (isLoading) {
    ...
    nextTick(() => {
      requestAnimationFrame(() => {
        logDataGridTiming("[PanDB][DataGrid:loading:stop:first-frame]", {
          traceId: dataGridTraceId,
          cacheKey: props.cacheKey,
          elapsedSinceSetup: dataGridElapsed(),
        });
