...
PanDB 是免费开源项目，但持续维护、数据库兼容性测试、基础设施建设和版本发布都需要长期投入时间与资源。
...
<table>
  ...
  <tr>
    ...
    <td>
      七牛云为 PanDB 提供对象存储、CDN 等云基础设施资源支持。
    </td>
    <td align="center" width="140">
...
- [支持 PanDB](https://my.feishu.cn/wiki/WMTkwdATDiiu4rk14JMcoyhTnoh) —— 通过微信或支付宝自愿捐助
