# PanDB DuckDB Standalone Driver

This directory contains the standalone Rust DuckDB sidecar. It reuses PanDB's
...
Point PanDB at the resulting executable with:
...
Release builds publish this driver through the PanDB driver registry. Driver
...
PanDB decompresses the package itself, so users do not need to install `zstd`,
