...
The Cassandra Agent uses Apache `cassandra-gocql-driver` and implements the PanDB
...
The Agent accepts both normal PanDB connection fields and Cassandra JDBC-style
