...
This guide defines the expected shape of a PanDB agent. Treat it as the checklist for adding or reviewing an agent.
...
- Talks to PanDB over stdin/stdout JSON-RPC 2.0.
