...
Rust-powered Model Context Protocol server for [DBX](https://github.com/ActiveInAI/Arch-GPT-DB). It lets MCP-compatible AI agents inspect schemas and run safe database operations using connections configured in DBX.

[中文说明](#中文说明) | [npm](https://www.npmjs.com/package/@dbx-app/mcp-server) | [Native releases](https://github.com/ActiveInAI/Arch-GPT-DB/releases?q=packages-v)
...
Every package release publishes native archives and `SHA256SUMS` in [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT-DB/releases?q=packages-v):
...
DBX MCP Server 是 [DBX](https://github.com/ActiveInAI/Arch-GPT-DB) 的 Rust MCP 服务，让 Claude Code、Cursor、Windsurf 等兼容 MCP 的 AI 工具使用 DBX 中已有的连接查询数据库。

[npm](https://www.npmjs.com/package/@dbx-app/mcp-server) | [原生版本下载](https://github.com/ActiveInAI/Arch-GPT-DB/releases?q=packages-v)
...
每个 packages 版本会在 [GitHub Releases](https://github.com/ActiveInAI/Arch-GPT-DB/releases?q=packages-v) 发布以下文件：
